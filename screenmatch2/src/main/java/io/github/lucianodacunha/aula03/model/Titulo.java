package io.github.lucianodacunha.aula03.model;
...
public class Titulo {
    ...
    public Titulo(TituloOMDb tituloOMDb){
        ...
        try {
            var array = tituloOMDb.runtime().split(" ");
            this.duracaoEmMinutos = Integer.parseInt(array[0]);
        } catch (Exception e) {
            throw new ErroDeParserDeDuracaDoFilmeException(
                    "Erro ao realizar o parser da duração do filme.");
        }
    }
